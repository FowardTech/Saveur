...
const CareerRoadmap = memo(() => {
  ...
  // Was fully free with no gate at all in the original plan for this
  // feature — matched to the same tier as the other "AI plans your path"
  // features (Curriculum Builder/Learning Courses), not a new tier of its
  // own. See entitlements_service.py's module docstring for the full
